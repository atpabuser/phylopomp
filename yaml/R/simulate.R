...
simulate.default <- function (object, ...) {
  if (missing(object) || is.null(object))
    message(
      ...
      "- BDEI: Linear birth-death with exposed and infectious classes\n",
      ...
      "- MTBD2: General 2-type linear multitype birth-death-sampling process (BDMM, Stadler psi/r parameterization)\n",
      "- MTBD3: General 3-type linear multitype birth-death-sampling process (BDMM, Stadler psi/r parameterization)\n",
...
simulate.gpsim <- function (object, time, ...) {
  ...
  switch(
    paste0("model",model),
    modelBDEI = continueBDEI(object,time=time,...),
    ...
    modelMTBD2 = continueMTBD2(object,time=time,...),
    modelMTBD3 = continueMTBD3(object,time=time,...),
